...
function CampaignSubConditionPage() {
    _s();
    const [subCondition, setSubCondition] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("Diabetes");
    ...
    const visiblePatientBars = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$date$2d$filter$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sliceMonths"])(data.patientBars, {
        startDate,
        endDate
    });
    const visibleRevenueSeries = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$date$2d$filter$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sliceMonths"])(data.revenueSeries, {
        startDate,
        endDate
    });
    const visibleMetrics = data.metrics.map((metric)=>({
            ...metric,
            value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$date$2d$filter$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["scaleDisplayValue"])(metric.value, monthRatio)
        }));
    ...
    const visibleEntities = data.entities.map((entity)=>({
            ...entity,
            patients: Number((0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$date$2d$filter$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["scaleDisplayValue"])(String(entity.patients), monthRatio).replace(/,/g, "")),
            revenue: Number((0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$date$2d$filter$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["scaleDisplayValue"])(String(entity.revenue), monthRatio).replace(/,/g, ""))
        }));
    const visibleEntitySummary = {
        entities: (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$date$2d$filter$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["scaleDisplayValue"])(String(visibleEntities.length), monthRatio),
        enrolled: (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$date$2d$filter$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["scaleDisplayValue"])("3,872", monthRatio),
        revenue: (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$date$2d$filter$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["scaleDisplayValue"])("Ð 528K", monthRatio)
    };
    const channels = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CampaignSubConditionPage.useMemo[channels]": ()=>data.channelBreakdown.filter({
                "CampaignSubConditionPage.useMemo[channels]": (channel)=>campaignType === "All" || channel.label === campaignType
            }["CampaignSubConditionPage.useMemo[channels]"]).map({
                "CampaignSubConditionPage.useMemo[channels]": (channel)=>({
                        ...channel,
                        count: (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$date$2d$filter$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["scaleDisplayValue"])(channel.count, monthRatio)
                    })
            }["CampaignSubConditionPage.useMemo[channels]"])
    }["CampaignSubConditionPage.useMemo[channels]"], [
        campaignType,
    ...
    const conversions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CampaignSubConditionPage.useMemo[conversions]": ()=>data.conversionSegments.filter({
                "CampaignSubConditionPage.useMemo[conversions]": (segment)=>condition === "All" ? true : condition === "Diabetes" ? [
                        "Chronic care",
                        "Preventive"
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: data.seenRate.segments.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        children: item.label
                                                    }, void 0, false, {
...
_s(CampaignSubConditionPage, "691TGYG2oEObe5LCkgBDUPv7upA=");
...
//# sourceMappingURL=_07hf9t~._.js.map